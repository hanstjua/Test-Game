...
public class InflictDamageAnimation : StateMachineBehaviour
{
    private TMP_Text _text;
    private InflictDamageAnimationParameters _parameters;
    ...
    {
        _parameters = animator.GetComponent<InflictDamageAnimationParameters>();
